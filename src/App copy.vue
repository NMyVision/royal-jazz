  ...
  <div class="bg-black/10 clear-both mt-40 border">
    <section class="max-w-screen-xl mx-auto bg-black/80 px-4 sm:px-10">
      <div class="md:grid grid-cols-1 items-center gap-4 sm:gap-10 py-10">
        <p class="text-center text-[#c39243] text-2xl" v-if="false">Join us for the last show of the series!</p>
        <div class="grid grid-cols-2">
          <div class="text-2xl text-white space-y-4 h-80">
            <p>
              Due to the heavy rain we've been experiencing, the Dave Koz performance has been
              <span class="font-bold text-rose-600">cancelled</span>. We want to be able to provide
              you with the best experience possible and a few extra days to dry out the venue will
              help us provide that for you. A full refund will be given to anyone who cannot make
              the new date.
            </p>

            <p>
              We apologize for the inconvenience, and we thank you for your continued support of The
              Amp Ballantyne and live music. We look forward to seeing you in a few weeks.
            </p>
          </div>
          <!--<template
